...
select * from empleado e1 where not exists (select * from empleado e2 where e2.FecInEmp>e1.FecInEmp);
-- 17
select * from centro where CodCen in (select CodCen from departamento where preanu < 1000000);